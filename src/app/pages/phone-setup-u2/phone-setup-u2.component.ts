...
@Component({
    selector: 'ami-fullstack-phone-setup-u2',
    templateUrl: './phone-setup-u2.component.html',
    styleUrls: ['./phone-setup-u2.component.scss']
})
export class PhoneSetupU2Component implements OnInit {
