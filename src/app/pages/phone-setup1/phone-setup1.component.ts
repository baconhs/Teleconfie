...
@Component({
    selector: 'ami-fullstack-phone-setup1',
    templateUrl: './phone-setup1.component.html',
    styleUrls: ['./phone-setup1.component.scss']
})
export class PhoneSetup1Component implements OnInit {
