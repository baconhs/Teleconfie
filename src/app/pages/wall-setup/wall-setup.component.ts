...
@Component({
    selector: 'ami-fullstack-wall-setup',
    templateUrl: './wall-setup.component.html',
    styleUrls: ['./wall-setup.component.scss']
})
export class WallSetupComponent implements OnInit {
