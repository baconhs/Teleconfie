...
@Component({
    selector: 'ami-fullstack-phone-setup-u3',
    templateUrl: './phone-setup-u3.component.html',
    styleUrls: ['./phone-setup-u3.component.scss']
})
export class PhoneSetupU3Component implements OnInit {
